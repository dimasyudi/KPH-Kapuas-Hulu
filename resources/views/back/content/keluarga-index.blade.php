      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('kelola-data-keluarga.store') }}" method="post" enctype="multipart/form-data">
              @csrf
  ...
  <table class="table" id="myTable">
    ...
    <tbody>
      @foreach($keluargas as $keluarga)
        @php
        $pegawai = App\Pegawai::where('nip', $keluarga->nip)->first();
        @endphp
      <tr>
        <td>{{ $pegawai->nama }}</td>
        <td>{{ $keluarga->nama }}</td>
          ...
          <div id="myModal{{ $keluarga->id }}" class="modal fade" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{ route('kelola-data-keluarga.update', ['id' => $keluarga->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <select name="nip">
                        @foreach($pegawais as $pegawai)
                        <option value="{{ $pegawai->nip }}" {{ $pegawai->nip === $keluarga->nip ? "selected" : "" }}>{{ $pegawai->nama }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="form-group">
