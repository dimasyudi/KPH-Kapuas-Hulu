...
<head>
    <!-- Meta-Information -->
    <title>@yield('title') | Panel Pegawai</title>
    <meta charset="utf-8">
...
<body class="expand-data panel-data">
    ...
    <!-- Topbar -->
    @include('pegawai.partials.topnav')
    <!-- End Topbar -->

    <!-- Side Header -->
    @include('pegawai.partials.leftnav')
    <!-- End Side Header -->
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.0/sweetalert.min.js" charset="utf-8"></script>
    ...
    <script type="text/javascript">
      $(document).ready( function () {
        ...
        $("select").change(function(){
            if($(this).val() == "Istri 2")
            {
                swal("Gagal !", "Data istri yang dapat dimasukkan hanya 1 !", "warning");
            }
        });
      } );
